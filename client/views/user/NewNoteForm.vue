<template>
  <div>
    <div class="block">
      ...
      <br >
      <p class="control">
        <button class="button is-default" @click="convertDelta()">Previzualizare</button>
        <button class="button is-primary" @click="addNote()">Trimitere</button>
        <button class="button is-link" @click="clear()">Anulare</button>
      </p>
    </div>
